...
import { FaFacebookF, FaPinterestP, FaLinkedinIn ,FaChevronRight,FaInstagram,FaTwitter, FaArrowUp  } from 'react-icons/fa';
      ...
      <footer className={`bg-[#0f0e0e] pt-30 text-white py-10 px-5 md:px-20`}>
        ...
        <div className="max-w-7xl mt-7 mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 z-50">
            ...
            <div className="flex gap-4 mt-4">
                <FaFacebookF className="cursor-pointer text-xl hover:text-[#b91202]" />
                <FaInstagram  className="cursor-pointer text-xl hover:text-[#b91202]" />
                <FaLinkedinIn className="cursor-pointer text-xl hover:text-[#b91202]" />
                <FaTwitter  className="cursor-pointer text-xl hover:text-[#b91202]" />
            </div>
            </div>
            ...
            <ul className="text-gray-400 text-sm space-y-2">
                ...
                <li className="hover:text-[#b91202] cursor-pointer flex items-center gap-1"><span><FaChevronRight className="text-[#b91202]" /></span> Penetration Testing</li>
