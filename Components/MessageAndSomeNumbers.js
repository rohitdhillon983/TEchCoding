  ...
  return (
    <div className='w-full overflow-hidden relative'>
      ...
      <div className='relative flex flex-col items-center justify-center max-w-10/12 mx-auto '>
                ...
                <div className="relative flex justify-between w-full max-[769px]:justify-center max-[426px]:flex-wrap gap-4">
                    ...
                    <div key={stat.id} className="flex items-center justify-center bg-[#181818bb] rounded-[50px_0_0_50px] shadow-lg ">
                        ...
                        <div className='mx-5 max-[769px]:mx-2 max-[769px]:max-w-[40%]'>
                            <h2 className="text-white text-5xl font-bold Rajdhani max-[769px]:text-3xl max-[426px]:text-2xl">{stat.value}</h2>
                            <p className="text-white text-lg Rajdhani mt-1 max-[769px]:text-sm max-[769px]:mt-0 max-[426px]:text-xs">{stat.label}</p>
                        </div>
                    </div>
                    ))}
                </div>
            ...
            <div className='relative flex items-center max-[769px]:my-8 mt-18 w-full max-[426px]:mt-0'>
                <div className='bg-white absolute max-[769px]:relative max-[769px]:max-w-full left-0 z-20 shadow-2xl p-14 max-[426px]:p-6 rounded-3xl max-w-[57%] MessageGsaP'>
                    <p className="text-[#b91202] text-lg Rajdhani font-bold tracking-wider max-[426px]:text-sm">
                        // Message
                    </p>
                    <h2 className="text-5xl font-bold text-gray-900 mt-2 Rajdhani max-[426px]:text-3xl max-[426px]:mt-0">
                    your business to growth please touch ?
                    </h2>
                    <div className='flex flex-col gap-7 mt-12 max-[426px]:mt-4 max-[426px]:gap-3 '>
