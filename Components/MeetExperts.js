  ...
  return (
    <section className="py-16 max-[426px]:py-8 bg-white">
      ...
      <h2 className="text-5xl font-bold text-gray-900 mt-2 Rajdhani max-[426px]:text-3xl max-[769px]:text-5xl">Empowering Connections <br /> Empowering <span className='text-[#b91202]'>Growth</span></h2>
        ...
        <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-6 mt-10 max-[426px]:px-4">
          {teamMembers.map((member, index) => (
            <div key={index} className="relative p-6 max-[426px]:p-4 bg-gray-100 rounded-xl shadow-lg BeforeSec overflow-hidden">
              ...
              <div className="flex flex-col text-left">
                ...
                <p className="text-[#b91202] text-lg uppercase max-[426px]:text-sm">{member.role}</p>
              </div>
            </div>
          ))}
        </div>
