  ...
  return (
    <div className="bg-gray-50 py-10 max-[769px]:py-5 mt-10">
      <div className="max-w-6xl mx-auto px-6 max-[426px]:px-4 max-[769px]:px-6">
        <div className="flex flex-wrap items-center justify-center gap-15 max-[769px]:gap-5 max-[426px]:gap-3">
          {clients.map((client, index) => (
            <div key={index} className="relative w-40 h-16 max-[769px]:w-28 max-[769px]:h-10">
