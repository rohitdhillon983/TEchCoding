        ...
        <section className="py-16 px-6 lg:px-20 bg-white">
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-6 text-center">
                ...
                <div className="flex flex-col hover:bg-[#b91202] group/contact hover:text-white p-8 rounded-2xl items-left text-left transition-all duration-700">
                    ...
                    <p className="text-gray-600 mt-2 group-hover/contact:text-gray-400">Telephone: +1(800)123-5466</p>
                    <p className="text-gray-600 group-hover/contact:text-gray-400">Email: info@example.com</p>
                ...
                <div className="flex flex-col hover:bg-[#b91202] group/media hover:text-white p-8 rounded-2xl items-left text-left transition-all duration-700">
                    ...
                    <div className="flex gap-4 mt-4">
                        ...
                        <a href="#" className=""><FaLinkedinIn className="cursor-pointer text-xl" /></a>
                        <a href="#" className=""><FaInstagram className="cursor-pointer text-xl" /></a>
                        <a href="#" className=""><FaTwitter className="cursor-pointer text-xl" /></a>
                    </div>
                </div>
