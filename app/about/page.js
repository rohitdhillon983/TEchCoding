        ...
        <div className="flex flex-col space-y-4 md:flex-row md:space-x-4 md:space-y-0" >
            <div className="flex flex-col justify-between space-y-4" >
                <div className="px-5 overflow-hidden bg-[#b91202] rounded-2xl py-5" >
                    <div >
                        <div >
                            <Image alt="Our Mission" loading="lazy" width="100" height="101" decoding="async" data-nimg="1" className="object-fill mb-6" src="https://swissmote.com/_next/static/media/our-mission.59796e78.svg" />
                        </div>
                ...
                <div className="px-5 overflow-hidden bg-[#b91202] rounded-2xl py-12" >
                    <div>
                        <div>
                            <Image alt="Our Goals" loading="lazy" width="150" height="150" decoding="async" data-nimg="1" className="object-fill mb-6" src="https://swissmote.com/_next/static/media/our-goal.0d90c0d3.svg" />
                        </div>
            ...
            <div className="flex flex-col justify-between space-y-4">
                <div className="px-5 overflow-hidden bg-[#b91202] rounded-2xl py-12" >
                    <div ><div >
                        <Image alt="Our Vision" loading="lazy" width="150" height="151" decoding="async" data-nimg="1" className="object-fill mb-6" src="https://swissmote.com/_next/static/media/our-vision.65d5be3b.svg" />
                    </div>
                ...
                <div className="px-5 overflow-hidden bg-[#b91202] rounded-2xl py-8" >
                    <div >
                        <div>
                            <Image alt="Our Partners" loading="lazy" width="100" height="101" decoding="async" data-nimg="1" className="object-fill mb-6" src="https://swissmote.com/_next/static/media/our-partners.670ff3c8.svg"/>
                        </div>
